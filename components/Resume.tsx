        ...
        <section id="resume" className="resume-section" aria-label="Resume download">
            <div className="container">
                ...
                >
                    ...
                    <a href="https://drive.google.com/file/d/1tbuWyokJN5f8HwhAlH7yRsWWRVjT8YEb/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="resume-button">
