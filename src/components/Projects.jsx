...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    <motion.div
      className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg h-full flex flex-col"
      variants={variants}
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
    ...
    >
      ...
      <div className="h-48 bg-gradient-to-r from-primary/80 to-secondary/80 flex items-center justify-center">
        <span className="text-white text-5xl">{project.icon}</span>
      </div>
      ...
      <div className="p-6 flex-grow">
        ...
        {/* Tech Stack */}
        <div className="mb-4">
          <h4 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-2">Tech Stack:</h4>
  ...
  const projects = [
    {
      ...
      description: 'A full-stack web application for booking bus tickets with user authentication, seat selection, and payment integration.',
      techStack: ['Spring Boot', 'SQL', 'RESTful API'],
